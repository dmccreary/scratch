# Learning Graph for Learning Computational Thinking with Scratch
...
This course's 200 concepts span computational thinking fundamentals, the Scratch interface,
sequencing, motion and coordinates, turtle-graphics-style drawing, loops, variables, conditionals,
custom blocks and abstraction, parameters, events, debugging, and the conceptual bridge to
